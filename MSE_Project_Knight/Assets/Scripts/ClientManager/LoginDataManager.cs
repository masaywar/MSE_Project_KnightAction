...
public class LoginDataManager : MonoBehaviour
{
    ...
    *************************************************************/
    public LoginData SignUpUser(string email, string username, string password)
    {
        ...
        HttpWebRequest request = (HttpWebRequest)WebRequest.Create(localURL + "signupuser");
        request.Method = "POST";
    ...
    *************************************************************/
    public LoginData SignInUser(string email, string password)
    {
        ...
        HttpWebRequest request = (HttpWebRequest)WebRequest.Create(localURL + "signinuser");
        request.Method = "POST";
        request.ContentType = "application/json";
        request.ContentLength = bytes.Length;
    ...
    *************************************************************/
    ...
    {   
        HttpWebRequest request = (HttpWebRequest)WebRequest.Create(localURL + "getall/logindata");
        HttpWebResponse response = (HttpWebResponse)request.GetResponse();
        StreamReader reader = new StreamReader(response.GetResponseStream());
        string json = reader.ReadToEnd();
    ...
    *************************************************************/
    public LoginData GetLoginDataByEmail(string email)
    {
        ...
        HttpWebRequest request = (HttpWebRequest)WebRequest.Create(localURL + "get/logindata");
        request.Method = "POST";
        request.ContentType = "application/json";
        request.ContentLength = bytes.Length;
    ...
    *************************************************************/
    public int UpdateLoginData(string email, string password, string userVersion)
    {
        ...
        HttpWebRequest request = (HttpWebRequest)WebRequest.Create(localURL + "update/logindata");
        request.Method = "POST";
        request.ContentType = "application/json";
        request.ContentLength = bytes.Length;
    ...
    *************************************************************/
    public int DeleteUser(string email, string username, string password)
    {
        ...
        HttpWebRequest request = (HttpWebRequest)WebRequest.Create(localURL + "delete");
        request.Method = "POST";
        request.ContentType = "application/json";
        request.ContentLength = bytes.Length;
