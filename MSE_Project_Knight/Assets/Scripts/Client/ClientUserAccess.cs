...
public class ClientUserAccess : MonoBehaviour
{
    ...
    public string realURL = "http://a4e6b6a50da0.ngrok.io/sak/";
    ...
    */
    ...
    public int UpdateUser(string email, string password, string userVersion)
    {
        ...
        RestClient.Post<Flag>(realURL + "updateuser", userData).Then(
            response =>
            {
                if (response.flag == 1){
                    returnValue = 1;
    ...
    */
    public int DeleteUser(string email, string username, string password)
    {
        ...
        RestClient.Post<Flag>(realURL + "deleteuser", userData).Then(
            response =>
            {
                if (response.flag == 1){
    ...
    public int updatePlayer(string name, int score, int coin, string companion){
        ...
        RestClient.Post<Flag>(realURL + "updateplayer", playerdata).Then(
            response =>
            {
                if (response.flag == 1){
                    // update succeed
    ...
    public Rank GetPlayerRank(string name){
        ...
        RestClient.Post<Rank>(realURL + "getrankscore", playerdata).Then(
            response =>
            {
                returnValue = response;
